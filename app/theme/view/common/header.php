                    ...
                    <div class="typeahead__container app-search">
                        <div class="typeahead__field">
                            <div class="typeahead__query">
                                ...
                                <input class="video-search form-control" name="q" type="text" id="search-input" placeholder="<?php echo __('Search for Movies, Series & Actors');?> .." autocomplete="off">
...
<script>
  ...
  OneSignal.push(function() {
    OneSignal.init({
      appId: "8f156c42-f251-47a6-a8c5-2c481512013f",
    });
  });
</script>
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3070533106345518"
