...
<div class="toolbar">
    ...
    <form class="flex-fill" method="post">
        <input type="text" name="search" class="form-control" placeholder="<?php echo __('Search for Actor');?> .." value="<?php echo $Filter['search'];?>" required>
    </form>
</div>
            ...
            <tr class="v-middle text-color">
                ...
                <td class="flex">
                    <a href="<?php echo APP.'/admin/'.$Config['page'].'/'.$Listing['id'];?>" class="text-color d-flex align-items-center">
                        <div class="media media-actor w-sm-thumb lazy" data-src="<?php echo UPLOAD.'/actor/thumb-'.$Listing['image'];?>"></div>
                        <div class="ml-3">
                            <div class="title">
