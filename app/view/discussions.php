...
<div class="toolbar">
    ...
    <form class="flex-fill" method="post">
        <input type="text" name="search" class="form-control" placeholder="<?php echo __('Search for Discussion');?> .." value="<?php echo $Filter['search'];?>" required>
    </form>
</div>
                    ...
                    <a href="<?php echo APP.'/admin/'.$Config['page'].'/'.$Listing['id'];?>" class="text-color d-flex align-items-center"> 
                        ...
                        <div class="ml-3">
                            <div class="title">
                                ...
                                <span class="badge bg-warning-lt ml-2"><?php echo __('Waiting for approval');?></span>
                                <?php } ?>
                            </div> 
