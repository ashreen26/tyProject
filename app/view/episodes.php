...
<div class="toolbar">
    ...
    <form class="flex-fill" method="post">
        <input type="text" name="search" class="form-control" placeholder="<?php echo __('Search for Episode');?> .." value="<?php echo $Filter['search'];?>" required>
    </form>
</div>
            ...
            <tr class="v-middle text-color">
                ...
                <td class="flex">
                    <a href="<?php echo APP.'/admin/'.$Config['page'].'/'.$Listing['content_id'].'/'.$Listing['id'];?>" class="d-flex align-items-center">
                        ...
                        <div class="ml-3">
                            <div class="title">
                                <?php echo $Listing['season'].'.'.__('Season').' '.$Listing['name'].'.'.__('Episode');?>
