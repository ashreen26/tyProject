...
<div class="toolbar">
    ...
    <form class="flex-fill" method="post">
        <input type="text" name="search" class="form-control" placeholder="<?php echo __('Search for Collection');?> .." value="<?php echo $Filter['search'];?>" required>
    </form>
</div>
        ...
        <div class="row align-items-center">
            <div class="col-md-3">
                <select name="privacy" class="custom-select">
                    ...
                    <option value="1" <?php if($Filter['privacy'] == '1') echo 'selected=""';?>><?php echo __('Open to everyone');?></option>
                    <option value="2" <?php if($Filter['privacy'] == '2') echo 'selected=""';?>><?php echo __('Only me');?></option>
                </select>
            </div>
            <div class="col-md-3">
            ...
            <tr class="v-middle text-color">
                ...
                <td class="flex">
                    <a href="<?php echo APP.'/admin/'.$Config['page'].'/'.$Listing['id'];?>" class="text-color d-flex align-items-center"> 
                        <?php echo gravatar($Listing['id'],null,$Listing['name'],'media w-sm-thumb lazy',$Listing['color']);?>
                        <div class="ml-3">
                            <div class="title">
                                <?php echo $Listing['name'];?> 
                            </div> 
                                <div class="text-muted text-12"><?php echo $Listing['user_name'];?></div> 
                        </div>
                    </a>
                </td>
