...
<div class="toolbar">
    ...
    <form class="flex-fill" method="post">
        <input type="text" name="search" class="form-control" placeholder="<?php echo __('Search for Language');?> .." value="<?php echo $Filter['search'];?>" required>
    </form>
</div>
    ...
    <table class="table table-theme">
        <thead class="text-muted">
            <tr>
                ...
                <th class="text-right"><span class="d-none d-sm-block">
                        <?php echo __('Action');?></span></th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr class="v-middle text-color">
                ...
                <td class="flex">
                    <a href="<?php echo APP.'/admin/'.$Config['page'].'/'.$Listing['id'];?>">
                        ...
                        <span class="badge bg-warning-lt ml-2">
                ...
                <td class="no-wrap table-link">
                    ...
                    <a href='<?php echo APP.'/admin/languages?submit={"_ACTION":"delete","id":"'.$Listing['id'].'"}'?>' class="confirm">
                        <svg class="icon">
